...
export type ChannelsDirectoryListParams = SchemaType<"ChannelsDirectoryListParams">;
export type ChannelsDirectoryListResult = SchemaType<"ChannelsDirectoryListResult">;
